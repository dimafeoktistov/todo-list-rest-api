define({ "api": [
    ...
    "examples": [
      {
        ...
        "content": "axios.delete('https://fast-sea-34727.herokuapp.com/todos/5be3f073b41d1e450c09dfa3', {headers: {Authorization: `jwt ${token}`}})",
        "type": "axios"
      }
    ],
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Пример использования:",
        "content": "axios.get('https://fast-sea-34727.herokuapp.com/todos/5be3f073b41d1e450c09dfa3', {headers: {Authorization: `jwt ${token}`}})",
        "type": "axios"
      }
    ],
    "filename": "routes/todos.js",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Пример использования:",
        "content": "axios.get(`https://fast-sea-34727.herokuapp.com/todos?userId=${userId}`, {headers: {Authorization: `jwt ${token}`}})",
        "type": "axios"
      }
    ],
    "filename": "routes/todos.js",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Пример использования:",
        "content": "axios.post('https://fast-sea-34727.herokuapp.com/todos', data, {headers: {Authorization: `jwt ${token}`}})",
        "type": "axios"
      }
    ],
    "filename": "routes/todos.js",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Пример использования:",
        "content": "axios.put('https://fast-sea-34727.herokuapp.com/todos/5be3f073b41d1e450c09dfa3', data, {headers: {Authorization: `jwt ${token}`}})",
        "type": "axios"
      }
    ],
    "filename": "routes/todos.js",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Пример использования:",
        "content": "axios.post('https://fast-sea-34727.herokuapp.com/auth', data)",
        "type": "axios"
      }
    ],
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Пример использования:",
        "content": "axios.post('https://fast-sea-34727.herokuapp.com/register', data)",
        "type": "axios"
      }
    ],
    "filename": "routes/user.js",
